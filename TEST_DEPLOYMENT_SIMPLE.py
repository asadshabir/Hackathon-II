...
def test_api_docs():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"[ERROR] API Docs error: {response.status_code}")
            return False
    except Exception as e:
...
def main():
    ...
    print("\\n" + "-" * 50)
    if success:
        print("[SUCCESS] All tests passed! Backend is deployed and accessible.")
        print("\\nNext steps:")
        ...
        print("[FAILED] Some tests failed. Please check the deployment.")
